...
class IO
  ...
  class << self
    ...
    #
    # pkg:gem/io-stream#lib/io/stream.rb:18
    def Stream(io); end
  end
end
...
class IO::Stream::Buffered < ::IO::Stream::Generic
  ...
  # @return [Boolean]
  #
  # pkg:gem/io-stream#lib/io/stream/buffered.rb:75
  def closed?; end

  # Returns the value of attribute io.
  #
  # pkg:gem/io-stream#lib/io/stream/buffered.rb:65
  def io; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/io-stream#lib/io/stream/buffered.rb:93
  def readable?; end

  # Get the underlying IO object.
  #
  # pkg:gem/io-stream#lib/io/stream/buffered.rb:69
  def to_io; end

  protected

  # pkg:gem/io-stream#lib/io/stream/buffered.rb:105
  def sysclose; end

  # Reads data from the underlying stream as efficiently as possible.
  #
  # pkg:gem/io-stream#lib/io/stream/buffered.rb:136
  def sysread(size, buffer); end

  # pkg:gem/io-stream#lib/io/stream/buffered.rb:111
  def syswrite(buffer); end

  class << self
    # Open a file and wrap it in a buffered stream.
    #
    # pkg:gem/io-stream#lib/io/stream/buffered.rb:17
    def open(path, mode = T.unsafe(nil), **options); end

    # Wrap an existing IO object in a buffered stream.
    #
    # pkg:gem/io-stream#lib/io/stream/buffered.rb:33
...
#
# pkg:gem/io-stream#lib/io/stream/connection_reset_error.rb:5
...
#
# pkg:gem/io-stream#lib/io/stream/generic.rb:17
class IO::Stream::Generic
  ...
  #
  # pkg:gem/io-stream#lib/io/stream/generic.rb:31
  def initialize(**options); end

  # Best effort to flush any unwritten data, and then close the underling IO.
  #
  # pkg:gem/io-stream#lib/io/stream/generic.rb:42
  def close; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/io-stream#lib/io/stream/generic.rb:37
  def closed?; end
  ...
  #
  # pkg:gem/io-stream#lib/io/stream/generic.rb:58
  def sysclose; end
  ...
  # @raise [NotImplementedError]
  #
  # pkg:gem/io-stream#lib/io/stream/generic.rb:72
  def sysread(size, buffer); end
  ...
  # @raise [NotImplementedError]
  #
  # pkg:gem/io-stream#lib/io/stream/generic.rb:66
  def syswrite(buffer); end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # pkg:gem/io-stream#lib/io/stream/generic.rb:25
...
module IO::Stream::Readable
  ...
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:57
  ...
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:74
  def block_size; end

  # Legacy setter for backwards compatibility
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:80
  def block_size=(value); end

  # Close the read end of the stream.
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:355
  def close_read; end

  # Efficiently discard data from the stream until encountering pattern.
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:228
  ...
  # @raise [EOFError]
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:335
  def eof!; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:325
  def eof?; end
  ...
  # @raise [EOFError]
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:328
  def finish!; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:315
  def finished?; end

  # Read a line from the stream, similar to IO#gets.
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:270
  ...
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:70
  ...
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:248
  def peek(size = T.unsafe(nil)); end

  # Read data from the stream.
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:88
  ...
  # @return [Boolean]
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:339
  def readable?; end

  # This is a compatibility shim for existing code that uses `readpartial`.
  #
  # pkg:gem/io-stream#lib/io/stream/readable.rb:169
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # pkg:gem/io-stream#lib/io/stream/readable.rb:49
    def async_safe?(method); end
  end
end
...
class OpenSSL::SSL::SSLSocket
  ...
  #
  # pkg:gem/io-stream#lib/io/stream/openssl.rb:69
  def buffered=(value); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/io-stream#lib/io/stream/openssl.rb:61
  def buffered?; end
