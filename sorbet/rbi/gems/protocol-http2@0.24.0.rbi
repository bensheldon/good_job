...
#
# pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:17
class Protocol::HTTP2::Connection
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:23
  def initialize(framer, local_stream_id); end

  # Access streams by ID, with 0 returning the connection itself.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:58
  def [](id); end
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:411
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:400
  ...
  # @return [Boolean]
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:492
  def client_stream_id?(id); end

  # Close the underlying framer and all streams.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:110
  def close(error = T.unsafe(nil)); end

  # Transition the connection into the closed state.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:215
  def close!; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:98
  def closed?; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:526
  def closed_stream_id?(id); end

  # Traverse active streams and allow them to consume the available flow-control window.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:552
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:434
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:418
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:154
  def dependencies; end

  # Returns the value of attribute dependency.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:156
  def dependency; end

  # Encode headers using HPACK compression.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:132
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:51
  def id; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:507
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:84
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:74
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:67
  def maximum_frame_size; end

  # Streams are identified with an unsigned 31-bit integer.  Streams initiated by a client MUST use odd-numbered stream identifiers; those initiated by the server MUST use even-numbered stream identifiers.  A stream identifier of zero (0x0) is used for connection control messages; the stream identifier of zero cannot be used to establish a new stream.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:144
  def next_stream_id; end

  # Transition the connection to the open state.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:322
  def open!; end
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:297
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:178
  def read_frame; end
  ...
  # @raise [ProtocolError]
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:587
  def receive_continuation(frame); end

  # Process a DATA frame from the remote peer.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:378
  def receive_data(frame); end

  # Receive and process a generic frame (default handler).
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:593
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:439
  def receive_headers(frame); end

  # Process a PING frame from the remote peer.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:358
  def receive_ping(frame); end

  # Receive and process a PRIORITY_UPDATE frame.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:475
  ...
  # @raise [ProtocolError]
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:468
  def receive_push_promise(frame); end

  # Receive and process a RST_STREAM frame.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:538
  def receive_reset_stream(frame); end

  # Receive and process a SETTINGS frame from the remote peer.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:331
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:95
  def remote_stream_id; end

  # Our window for sending data. When we send data, it reduces this window.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:92
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:222
  def send_goaway(error_code = T.unsafe(nil), message = T.unsafe(nil)); end

  # Send a PING frame to the remote peer.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:344
  def send_ping(data); end

  # Send updated settings to the remote peer.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:205
  ...
  # @return [Boolean]
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:500
  def server_stream_id?(id); end

  # Connection state (:new, :open, :closed).
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:81
  def state; end
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:152
  def streams; end
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:274
  def update_local_settings(changes); end

  # Update remote settings and adjust stream window capacities.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:286
  ...
  # @return [Boolean]
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:394
  def valid_remote_stream_id?(stream_id); end

  # Write a single frame to the connection.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:248
  def write_frame(frame); end

  # Write multiple frames within a synchronized block.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/connection.rb:260
...
#
# pkg:gem/protocol-http2#lib/protocol/http2/error.rb:113
...
class Protocol::HTTP2::FrameSizeError < ::Protocol::HTTP2::ProtocolError
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/error.rb:98
  def initialize(message); end
end
...
class Protocol::HTTP2::GoawayFrame < ::Protocol::HTTP2::Frame
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/goaway_frame.rb:50
  def apply(connection); end
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/goaway_frame.rb:44
...
#
# pkg:gem/protocol-http2#lib/protocol/http2/error.rb:58
class Protocol::HTTP2::HandshakeError < ::Protocol::HTTP2::Error; end

# Represents a header processing error.
#
# pkg:gem/protocol-http2#lib/protocol/http2/error.rb:104
class Protocol::HTTP2::HeaderError < ::Protocol::HTTP2::StreamClosed
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/error.rb:107
  def initialize(message); end
end
...
#
# pkg:gem/protocol-http2#lib/protocol/http2/error.rb:64
class Protocol::HTTP2::ProtocolError < ::Protocol::HTTP2::Error
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/error.rb:68
...
class Protocol::HTTP2::Stream
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:444
  ...
  # Override this function to implement your own push promise logic.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:422
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:331
  def ignore_data(frame); end

  # Get a string representation of the stream.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:462
  def inspect; end
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:325
  def process_data(frame); end

  # Process headers frame and decode the header block.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:279
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:336
  def receive_data(frame); end

  # Receive and process a headers frame on this stream.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:292
  def receive_headers(frame); end

  # Receive and process a PUSH_PROMISE frame on this stream.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:450
  def receive_push_promise(frame); end

  # Receive and process a RST_STREAM frame on this stream.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:365
  def receive_reset_stream(frame); end
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:398
  def reserved_local!; end

  # Transition stream to reserved remote state.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:411
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:428
  def send_push_promise(headers); end

  # Send a RST_STREAM frame to reset this stream.
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:263
  ...
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:286
  ...
  #
  # pkg:gem/protocol-http2#lib/protocol/http2/stream.rb:381
...
#
# pkg:gem/protocol-http2#lib/protocol/http2/error.rb:82
...
#
# pkg:gem/protocol-http2#lib/protocol/http2/error.rb:78
