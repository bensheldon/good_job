...
#
# pkg:gem/actionview#lib/action_view/testing/resolvers.rb:10
class ActionView::FixtureResolver < ::ActionView::FileSystemResolver
  # @return [FixtureResolver] a new instance of FixtureResolver
  #
  # pkg:gem/actionview#lib/action_view/testing/resolvers.rb:11
  def initialize(hash = T.unsafe(nil)); end

  # pkg:gem/actionview#lib/action_view/testing/resolvers.rb:17
  def data; end

  # pkg:gem/actionview#lib/action_view/testing/resolvers.rb:21
  def to_s; end

  private

  # pkg:gem/actionview#lib/action_view/testing/resolvers.rb:32
  def source_for_template(template); end

  # pkg:gem/actionview#lib/action_view/testing/resolvers.rb:26
  def template_glob(glob); end
end
...
# pkg:gem/actionview#lib/action_view/testing/resolvers.rb:37
class ActionView::NullResolver < ::ActionView::Resolver
  # pkg:gem/actionview#lib/action_view/testing/resolvers.rb:38
