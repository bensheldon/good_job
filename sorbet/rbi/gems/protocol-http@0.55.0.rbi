...
class Protocol::HTTP::Header::Accept < ::Array
  ...
  #
  # source://protocol-http//lib/protocol/http/header/accept.rb#74
  ...
  #
  # source://protocol-http//lib/protocol/http/header/accept.rb#85
  def <<(value); end

  # Parse the `accept` header.
  #
  # source://protocol-http//lib/protocol/http/header/accept.rb#105
  def media_ranges; end

  # Serializes the stored values into a comma-separated string.
  #
  # source://protocol-http//lib/protocol/http/header/accept.rb#92
  def to_s; end

  private

  # source://protocol-http//lib/protocol/http/header/accept.rb#113
...
# source://protocol-http//lib/protocol/http/header/accept.rb#26
...
class Protocol::HTTP::Header::Connection < ::Protocol::HTTP::Header::Split
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://protocol-http//lib/protocol/http/header/connection.rb#57
    def trailer?; end
  end
end
...
class Protocol::HTTP::Header::Date < ::String
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://protocol-http//lib/protocol/http/header/date.rb#32
    def trailer?; end
  end
end
...
# source://protocol-http//lib/protocol/http/header/digest.rb#26
...
class Protocol::HTTP::Header::Multiple < ::Array
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://protocol-http//lib/protocol/http/header/multiple.rb#32
    def trailer?; end
  end
end
...
# source://protocol-http//lib/protocol/http/header/server_timing.rb#26
...
#
# source://protocol-http//lib/protocol/http/header/cookie.rb#38
...
class Protocol::HTTP::Header::Split < ::Array
  ...
  # source://protocol-http//lib/protocol/http/header/split.rb#52
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://protocol-http//lib/protocol/http/header/split.rb#46
    def trailer?; end
  end
end
...
class Protocol::HTTP::Header::TE < ::Protocol::HTTP::Header::Split
  ...
  #
  # @return [TE] a new instance of TE
  #
  # source://protocol-http//lib/protocol/http/header/te.rb#68
  def initialize(value = T.unsafe(nil)); end

  # Adds one or more comma-separated values to the TE header. The values are converted to lowercase for normalization.
  #
  # source://protocol-http//lib/protocol/http/header/te.rb#75
  def <<(value); end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/te.rb#93
  def chunked?; end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/te.rb#108
  def compress?; end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/te.rb#103
  def deflate?; end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/te.rb#98
  def gzip?; end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/te.rb#113
  def identity?; end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/te.rb#118
  def trailers?; end

  # Parse the `te` header value into a list of transfer codings with quality factors.
  #
  # source://protocol-http//lib/protocol/http/header/te.rb#82
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://protocol-http//lib/protocol/http/header/te.rb#125
    def trailer?; end
  end
end
...
# source://protocol-http//lib/protocol/http/header/te.rb#17
...
class Protocol::HTTP::Header::TransferEncoding < ::Protocol::HTTP::Header::Split
  ...
  #
  # @return [TransferEncoding] a new instance of TransferEncoding
  #
  # source://protocol-http//lib/protocol/http/header/transfer_encoding.rb#33
  def initialize(value = T.unsafe(nil)); end
  ...
  #
  # source://protocol-http//lib/protocol/http/header/transfer_encoding.rb#40
  def <<(value); end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/transfer_encoding.rb#45
  def chunked?; end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/transfer_encoding.rb#60
  def compress?; end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/transfer_encoding.rb#55
  def deflate?; end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/transfer_encoding.rb#50
  def gzip?; end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/header/transfer_encoding.rb#65
  def identity?; end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://protocol-http//lib/protocol/http/header/transfer_encoding.rb#72
    def trailer?; end
  end
end
...
class Protocol::HTTP::Headers
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#73
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#432
  def ==(other); end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#241
  def []=(key, value); end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#420
  def as_json; end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#340
  def delete(key); end

  # Enumerate all header keys and values.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#193
  def each(&block); end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#126
  def flatten; end

  # Flatten trailer into the headers, in-place.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#116
  def flatten!; end

  # Freeze the headers, and ensure the indexed hash is generated.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#171
  def freeze; end
  ...
  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/headers.rb#202
  def key?(key); end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#263
  def merge(headers); end

  # Merge the headers into this instance.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#254
  def merge!(headers); end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#93
  def policy=(policy); end

  # Set the specified header key to the specified value, replacing any existing header keys with the same name.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#247
  def set(key, value); end

  # Returns the value of attribute tail.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#134
  def tail; end

  # source://protocol-http//lib/protocol/http/headers.rb#137
  def to_a; end

  # Compute a hash table of headers, where the keys are normalized to lower case and the values are normalized according to the policy for that header.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#406
  def to_h; end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#155
  def trailer!(&block); end

  # @return [Boolean]
  #
  # source://protocol-http//lib/protocol/http/headers.rb#142
  def trailer?; end
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#369
  def merge_into(hash, key, value, trailer = T.unsafe(nil)); end

  private

  # Initialize a copy of the headers.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#101
  ...
  class << self
    ...
    #
    # source://protocol-http//lib/protocol/http/headers.rb#47
    def [](headers); end
  end
end
...
#
# source://protocol-http//lib/protocol/http/headers.rb#444
class Protocol::HTTP::Headers::Merged
  ...
  #
  # source://protocol-http//lib/protocol/http/headers.rb#450
  def initialize(*all); end

  # Add a new set of headers to the merged list.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#472
  def <<(headers); end

  # Clear the references to all headers.
  #
  # source://protocol-http//lib/protocol/http/headers.rb#465
  def clear; end
  ...
  # source://protocol-http//lib/protocol/http/headers.rb#455
  def fields; end

  # source://protocol-http//lib/protocol/http/headers.rb#460
  def flatten; end
end
...
#
# source://protocol-http//lib/protocol/http/headers.rb#268
