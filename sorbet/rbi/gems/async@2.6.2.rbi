...
class Async::Scheduler < ::Async::Node
  ...
  #
  # source://async//lib/async/scheduler.rb#284
  def async(*arguments, **options, &block); end

  # Invoked when a fiber tries to perform a blocking operation which cannot continue. A corresponding call {unblock} must be performed to allow this fiber to continue.
  #
  # source://async//lib/async/scheduler.rb#115
  ...
  # source://async//lib/async/scheduler.rb#302
  ...
  #
  # source://async//lib/async/scheduler.rb#203
  def process_wait(pid, flags); end

  # Schedule a fiber (or equivalent object) to be resumed on the next loop through the reactor.
  #
  # source://async//lib/async/scheduler.rb#101
  def push(fiber); end
  ...
  # source://async//lib/async/scheduler.rb#322
  ...
  #
  # source://async//lib/async/scheduler.rb#308
  ...
  #
  # source://async//lib/async/scheduler.rb#227
  def run_once!(timeout = T.unsafe(nil)); end
...
class Async::Task < ::Async::Node
  ...
  # source://async//lib/async/task.rb#107
  def annotation; end
  ...
  #
  # source://async//lib/async/task.rb#221
  def result; end
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#151
  def running?; end

  # @deprecated Prefer {Kernel#sleep} except when compatibility with `stable-v1` is required.
  #
  # source://async//lib/async/task.rb#120
  ...
  #
  # source://async//lib/async/task.rb#303
  ...
  # source://async//lib/async/task.rb#345
  def schedule(&block); end

  # Set the current fiber's `:async_task` to this task.
  #
  # source://async//lib/async/task.rb#368
  def set!; end

  # source://async//lib/async/task.rb#339
  def stop!; end
  ...
  class << self
    ...
    #
    # source://async//lib/async/task.rb#264
    def current; end
    ...
    # @return [Boolean]
    #
    # source://async//lib/async/task.rb#270
    def current?; end

    # @deprecated With no replacement.
    #
    # source://async//lib/async/task.rb#69
    def yield; end
  end
end
