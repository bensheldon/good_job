...
# pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:30
...
module RSpec
  class << self
    # pkg:gem/rspec-rails#lib/rspec/rails/example/feature_example_group.rb:49
...
module RSpec::Rails
  class << self
    ...
    # @api private
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/configuration.rb:46
    def add_test_type_configurations(config); end

    # @private
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/configuration.rb:59
    ...
    # @private
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:9
...
#
# pkg:gem/rspec-rails#lib/rspec/rails/active_record.rb:5
class RSpec::Rails::ActiveRecordConfiguration
  class << self
    # @private
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/active_record.rb:7
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/channel_example_group.rb:8
module RSpec::Rails::ChannelExampleGroup
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/channel_example_group.rb:58
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/channel_example_group.rb:86
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/channel_example_group.rb:76
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/channel_example_group.rb:66
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/channel_example_group.rb:10
module RSpec::Rails::ChannelExampleGroup::ClassMethods
  # @api public
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/channel_example_group.rb:32
  def channel_class; end

  # @api public
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/channel_example_group.rb:43
...
# these are dynamically added to the normal RSpec configuration object.
#
# pkg:gem/rspec-rails#lib/rspec/rails/configuration.rb:5
class RSpec::Rails::Configuration; end

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:4
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:10
module RSpec::Rails::ControllerExampleGroup
  ...
  #   end
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:166
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:128
  def controller; end
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:172
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:132
  def routes; end
  ...
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:137
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:201
  def route_available?(method); end

  # @api public
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:206
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:143
module RSpec::Rails::ControllerExampleGroup::BypassRescue
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:144
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:21
module RSpec::Rails::ControllerExampleGroup::ClassMethods
  ...
  #   within the block.
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:61
  def controller(base_class = T.unsafe(nil), &body); end

  # @api public
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:23
  ...
  #   end
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/controller_example_group.rb:119
  def routes; end
end
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/configuration.rb:27
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/feature_example_group.rb:5
module RSpec::Rails::FeatureExampleGroup
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/feature_example_group.rb:27
  def visit(*_arg0); end
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/feature_example_group.rb:10
RSpec::Rails::FeatureExampleGroup::DEFAULT_HOST = T.let(T.unsafe(nil), String)

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/file_fixture_support.rb:6
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/fixture_file_upload_support.rb:4
module RSpec::Rails::FixtureFileUploadSupport
  # pkg:gem/rspec-rails#lib/rspec/rails/fixture_file_upload_support.rb:5
  ...
  # the old accessor.
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/fixture_file_upload_support.rb:12
  def rails_fixture_file_wrapper; end
end

# pkg:gem/rspec-rails#lib/rspec/rails/fixture_file_upload_support.rb:24
class RSpec::Rails::FixtureFileUploadSupport::RailsFixtureFileWrapper
  include ::ActionDispatch::TestProcess::FixtureFile
  include ::ActionDispatch::TestProcess
  include ::ActiveSupport::Testing::FileFixtures

  # pkg:gem/rspec-rails#lib/rspec/rails/fixture_file_upload_support.rb:26
  def file_fixture_path; end
  ...
  class << self
    ...
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/fixture_file_upload_support.rb:29
    def fixture_paths; end
    ...
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/fixture_file_upload_support.rb:32
    def instance; end
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/fixture_support.rb:4
module RSpec::Rails::FixtureSupport
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/fixture_support.rb:14
...
# pkg:gem/rspec-rails#lib/rspec/rails/fixture_support.rb:32
...
# pkg:gem/rspec-rails#lib/rspec/rails/fixture_support.rb:35
module RSpec::Rails::FixtureSupport::Fixtures::ClassMethods
  # pkg:gem/rspec-rails#lib/rspec/rails/fixture_support.rb:36
  def fixtures(*args); end

  # pkg:gem/rspec-rails#lib/rspec/rails/fixture_support.rb:44
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/helper_example_group.rb:7
module RSpec::Rails::HelperExampleGroup
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/helper_example_group.rb:22
  def helper; end
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/helper_example_group.rb:31
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/helper_example_group.rb:14
module RSpec::Rails::HelperExampleGroup::ClassMethods
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/helper_example_group.rb:15
  def determine_constant_from_test_name(_ignore); end
end

# Container module for job spec functionality.
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/job_example_group.rb:6
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/mailbox_example_group.rb:5
module RSpec::Rails::MailboxExampleGroup
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/mailbox_example_group.rb:44
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/mailbox_example_group.rb:54
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/mailbox_example_group.rb:64
  def have_failed; end
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/mailbox_example_group.rb:73
  ...
  class << self
    ...
    # @private
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/example/mailbox_example_group.rb:13
    def create_inbound_email(arg); end
  end
end

# pkg:gem/rspec-rails#lib/rspec/rails/example/mailbox_example_group.rb:27
module RSpec::Rails::MailboxExampleGroup::ClassMethods
  # pkg:gem/rspec-rails#lib/rspec/rails/example/mailbox_example_group.rb:29
  def mailbox_class; end
end

# Container module for mailer spec functionality.
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/mailer_example_group.rb:6
...
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/mailer_example_group.rb:29
module RSpec::Rails::MailerExampleGroup::ClassMethods
  # Alias for `described_class`.
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/mailer_example_group.rb:31
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers.rb:9
module RSpec::Rails::Matchers
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_a_new.rb:78
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_new_record.rb:25
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_valid.rb:44
  def be_valid(*args); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable.rb:56
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:255
  ...
  #   }
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:415
  ...
  #   }.to have_enqueued_mail(MyMailer, :welcome).on_queue(:urgent_mail)
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:254
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:446
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:519
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable.rb:50
  ...
  #   }.to have_enqueued_mail(MyMailer, :welcome).on_queue(:urgent_mail)
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:253
  ...
  #   }
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:411
  ...
  #   }.to have_enqueued_mail(MyMailer, :welcome).on_queue(:urgent_mail)
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:250
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:374
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:486
  ...
  #   }.to have_performed_job.with(42).on_queue("low").at(Date.tomorrow.noon)
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:490
  ...
  #   attributes used to build one
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:68
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:117
  ...
  # @raise [StandardError]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable.rb:63
  def check_action_cable_adapter; end

  # @private
  # @raise [StandardError]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:527
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:4
module RSpec::Rails::Matchers::ActionCable; end

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:7
class RSpec::Rails::Matchers::ActionCable::HaveBroadcastedTo < ::RSpec::Matchers::BuiltIn::BaseMatcher
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:8
  def initialize(target, channel:); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:28
  def at_least(count); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:33
  def at_most(count); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:54
  def description; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:23
  def exactly(count); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:58
  def failure_message; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:69
  def failure_message_when_negated; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:95
  def from_channel(channel); end

  # @raise [ArgumentError]
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:85
  def matches?(proc); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:73
  def message_expectation_modifier; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:42
  def once; end

  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:81
  def supports_block_expectations?; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:50
  def thrice; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:38
  def times; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:46
  def twice; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:16
  def with(data = T.unsafe(nil), &block); end

  private

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:147
  def base_description; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:153
  def base_message; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:114
  def check(messages); end

  # @raise [ArgumentError]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:169
  def check_channel_presence; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:157
  def data_description(data); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:165
  def pubsub_adapter; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:136
  def set_expected_number(relativity, count); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_broadcasted_to.rb:102
  def stream; end
end
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_streams.rb:8
class RSpec::Rails::Matchers::ActionCable::HaveStream < ::RSpec::Matchers::BuiltIn::BaseMatcher
  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_streams.rb:31
  def does_not_match?(subscription); end

  # @api private
  # @return [String]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_streams.rb:11
  def failure_message; end

  # @api private
  # @return [String]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_streams.rb:17
  def failure_message_when_negated; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_streams.rb:23
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_streams.rb:47
  def base_message; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_streams.rb:37
  def match(subscription); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_cable/have_streams.rb:51
  def no_expected?; end
end
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:7
module RSpec::Rails::Matchers::ActionMailbox; end

# @api private
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:9
class RSpec::Rails::Matchers::ActionMailbox::Base < ::RSpec::Rails::Matchers::BaseMatcher
  private

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:12
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:18
class RSpec::Rails::Matchers::ActionMailbox::ReceiveInboundEmail < ::RSpec::Rails::Matchers::ActionMailbox::Base
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:19
  def initialize(message); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:41
  def failure_message; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:49
  def failure_message_when_negated; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:33
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:57
  def describe_inbound_email; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/action_mailbox.rb:55
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:10
module RSpec::Rails::Matchers::ActiveJob; end

# @api private
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:13
class RSpec::Rails::Matchers::ActiveJob::Base < ::RSpec::Rails::Matchers::BaseMatcher
  # @api private
  # @return [Base] a new instance of Base
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:14
  def initialize; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:39
  def at(time_or_date); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:53
  def at_least(count); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:58
  def at_most(count); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:34
  def at_priority(priority); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:48
  def exactly(count); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:79
  def failure_message; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:92
  def failure_message_when_negated; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:96
  def message_expectation_modifier; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:29
  def on_queue(queue); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:67
  def once; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:104
  def supports_block_expectations?; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:75
  def thrice; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:63
  def times; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:71
  def twice; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:23
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:170
  def arguments_match?(job); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:222
  def at_match?(job); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:145
  def base_job_message(job); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:135
  def base_message; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:110
  def check(jobs); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:201
  def check_args_signature_mismatch(job_class, job_method, args); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:231
  def check_for_inprecise_value(scheduled_at); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:269
  def deserialize_arguments(job); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:180
  def detect_args_signature_mismatch(jobs); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:166
  def job_matches?(job); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:162
  def matches_constraints?(job); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:216
  def priority_match?(job); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:275
  def queue_adapter; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:210
  def queue_match?(job); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:262
  def serialize_and_deserialize_arguments(args); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:252
  def set_expected_number(relativity, count); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:194
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:309
class RSpec::Rails::Matchers::ActiveJob::HaveBeenEnqueued < ::RSpec::Rails::Matchers::ActiveJob::Base
  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:318
  def does_not_match?(proc); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:313
  def matches?(job); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:324
  def supports_block_expectations?; end
end

# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:310
RSpec::Rails::Matchers::ActiveJob::HaveBeenEnqueued::FAILURE_MESSAGE_EXPECTATION_ACTION = T.let(T.unsafe(nil), String)

# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:311
RSpec::Rails::Matchers::ActiveJob::HaveBeenEnqueued::MESSAGE_EXPECTATION_ACTION = T.let(T.unsafe(nil), String)

# @api private
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:351
class RSpec::Rails::Matchers::ActiveJob::HaveBeenPerformed < ::RSpec::Rails::Matchers::ActiveJob::Base
  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:355
  def matches?(job); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:360
  def supports_block_expectations?; end
end

# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:352
RSpec::Rails::Matchers::ActiveJob::HaveBeenPerformed::FAILURE_MESSAGE_EXPECTATION_ACTION = T.let(T.unsafe(nil), String)

# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:353
RSpec::Rails::Matchers::ActiveJob::HaveBeenPerformed::MESSAGE_EXPECTATION_ACTION = T.let(T.unsafe(nil), String)

# @api private
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:282
class RSpec::Rails::Matchers::ActiveJob::HaveEnqueuedJob < ::RSpec::Rails::Matchers::ActiveJob::Base
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:286
  def initialize(job); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:301
  def does_not_match?(proc); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:291
  def matches?(proc); end
end

# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:283
RSpec::Rails::Matchers::ActiveJob::HaveEnqueuedJob::FAILURE_MESSAGE_EXPECTATION_ACTION = T.let(T.unsafe(nil), String)

# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:284
RSpec::Rails::Matchers::ActiveJob::HaveEnqueuedJob::MESSAGE_EXPECTATION_ACTION = T.let(T.unsafe(nil), String)

# @api private
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:330
class RSpec::Rails::Matchers::ActiveJob::HavePerformedJob < ::RSpec::Rails::Matchers::ActiveJob::Base
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:334
  def initialize(job); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:339
  def matches?(proc); end
end

# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:331
RSpec::Rails::Matchers::ActiveJob::HavePerformedJob::FAILURE_MESSAGE_EXPECTATION_ACTION = T.let(T.unsafe(nil), String)

# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/active_job.rb:332
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:7
class RSpec::Rails::Matchers::BaseMatcher
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:21
  def initialize(expected = T.unsafe(nil)); end

  # @api private
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:16
  def actual; end

  # @api private
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:85
  ...
  # @return [String]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:53
  def description; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:62
  def diffable?; end
  ...
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:80
  def expected_formatted; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:75
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:40
  def match_unless_raises(*exceptions); end

  # @api private
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:95
  def matcher_name; end

  # @api private
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:19
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:29
  def matches?(actual); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:124
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:70
  def supports_block_expectations?; end
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:117
  ...
  class << self
    ...
    # @private
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:90
    def matcher_name; end
    ...
    # @private
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:105
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:147
module RSpec::Rails::Matchers::BaseMatcher::DefaultFailureMessages
  ...
  # @return [String]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:153
  def failure_message; end
  ...
  # @return [String]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:162
  def failure_message_when_negated; end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:167
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:127
module RSpec::Rails::Matchers::BaseMatcher::HashFormatting
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:137
  ...
  class << self
    ...
    # @api private
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:140
    def improve_hash_formatting(inspect_string); end
  end
end
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/base_matcher.rb:13
...
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_a_new.rb:9
class RSpec::Rails::Matchers::BeANew < ::RSpec::Rails::Matchers::BaseMatcher
  # @api private
  # @private
  # @return [BeANew] a new instance of BeANew
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_a_new.rb:11
  def initialize(expected); end

  # @api private
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_a_new.rb:29
  def failure_message; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_a_new.rb:16
  def matches?(actual); end

  # @api public
  # @see RSpec::Rails::Matchers#be_a_new
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_a_new.rb:23
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_a_new.rb:47
  def attributes; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_a_new.rb:51
  def attributes_match?(actual); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_a_new.rb:57
  def unmatched_attributes; end
end

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_new_record.rb:5
class RSpec::Rails::Matchers::BeANewRecord < ::RSpec::Rails::Matchers::BaseMatcher
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_new_record.rb:10
  def failure_message; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_new_record.rb:14
  def failure_message_when_negated; end

  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_new_record.rb:6
  def matches?(actual); end
end

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_valid.rb:5
class RSpec::Rails::Matchers::BeValid < ::RSpec::Matchers::BuiltIn::Be
  # @return [BeValid] a new instance of BeValid
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_valid.rb:6
  def initialize(*args); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_valid.rb:15
  def failure_message; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_valid.rb:31
  def failure_message_when_negated; end

  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/be_valid.rb:10
  def matches?(actual); end
end
...
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:15
class RSpec::Rails::Matchers::HaveEnqueuedMail < ::RSpec::Rails::Matchers::ActiveJob::HaveEnqueuedJob
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:20
  def initialize(mailer_class, method_name); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:27
  def description; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:43
  def failure_message; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:51
  def failure_message_when_negated; end

  # @raise [ArgumentError]
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:36
  def matches?(block); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:31
  def with(*args, &block); end
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:79
  def arguments_match?(job); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:111
  def base_mailer_args; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:57
  def base_message; end

  # @raise [StandardError]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:119
  def check_active_job_adapter; end
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:157
  def deserialize_arguments(job); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:94
  def detect_args_signature_mismatch(jobs); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:67
  def expected_count_message; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:179
  def extract_args_without_parameterized_params(job); end

  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:75
  def job_matches?(job); end

  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:192
  def legacy_mail?(job); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:141
  def mail_job_message(job); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:71
  def mailer_class_name; end

  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:196
  def parameterized_mail?(job); end

  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:200
  def unified_mail?(job); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:125
  def unmatching_mail_jobs; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:131
  def unmatching_mail_jobs_message; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:115
  def yield_mail_args(block); end
end

# pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_enqueued_mail.rb:16
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:13
module RSpec::Rails::Matchers::HaveHttpStatus
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:60
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:35
  ...
  class << self
    ...
    # @return [ActionDispatch::TestResponse]
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:56
    def as_test_response(obj); end
    ...
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:19
...
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:237
class RSpec::Rails::Matchers::HaveHttpStatus::GenericStatus < ::RSpec::Rails::Matchers::BaseMatcher
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:251
  def initialize(type); end

  # @api private
  # @return [String]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:273
  def description; end

  # @api private
  # @return [String] explaining why the match failed
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:278
  def failure_message; end

  # @api private
  # @return [String] explaining why the match failed
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:284
  def failure_message_when_negated; end
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:263
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:297
  ...
  # @see https://github.com/rails/rails/blob/main/actionpack/lib/action_dispatch/testing/test_response.rb `ActionDispatch::TestResponse`
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:314
  def type_codes; end

  # @api private
  # @return [String] formatting the expected status and associated code(s)
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:305
  ...
  class << self
    ...
    # @see https://github.com/rails/rails/blob/main/actionpack/lib/action_dispatch/testing/test_response.rb `ActionDispatch::TestResponse`
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:243
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:291
...
# @see RSpec::Rails::Matchers#have_http_status
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:77
class RSpec::Rails::Matchers::HaveHttpStatus::NumericCode < ::RSpec::Rails::Matchers::BaseMatcher
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:80
  def initialize(code); end

  # @api private
  # @return [String]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:98
  def description; end

  # @api private
  # @return [String] explaining why the match failed
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:103
  def failure_message; end

  # @api private
  # @return [String] explaining why the match failed
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:110
  def failure_message_when_negated; end
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:88
  def matches?(response); end
end
...
# @see https://github.com/rack/rack/blob/master/lib/rack/utils.rb `Rack::Utils::SYMBOL_TO_STATUS_CODE`
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:128
class RSpec::Rails::Matchers::HaveHttpStatus::SymbolicStatus < ::RSpec::Rails::Matchers::BaseMatcher
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:131
  def initialize(status); end

  # @api private
  # @return [String]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:151
  def description; end

  # @api private
  # @return [String] explaining why the match failed
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:156
  def failure_message; end

  # @api private
  # @return [String] explaining why the match failed
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:163
  def failure_message_when_negated; end
  ...
  #   the `response` code
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:141
  def matches?(response); end
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:176
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:187
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:170
  def expected_status; end

  # @api private
  # @return [String] pretty format the actual response status
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:195
  def pp_actual; end

  # @api private
  # @return [String] pretty format the expected status and associated code
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:200
  def pp_expected; end

  # @api private
  # @return [String] pretty format the actual response status
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:205
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_http_status.rb:218
  def set_expected_code!; end
end

# Matcher for redirects.
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/redirect_to.rb:5
module RSpec::Rails::Matchers::RedirectTo
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/redirect_to.rb:32
  def redirect_to(target); end
end

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/redirect_to.rb:7
class RSpec::Rails::Matchers::RedirectTo::RedirectTo < ::RSpec::Rails::Matchers::BaseMatcher
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/redirect_to.rb:8
  def initialize(scope, expected); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/redirect_to.rb:19
  def failure_message; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/redirect_to.rb:23
  def failure_message_when_negated; end

  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/redirect_to.rb:13
  def matches?(_); end
end

# Matcher for template rendering.
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_rendered.rb:5
module RSpec::Rails::Matchers::RenderTemplate
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_rendered.rb:56
  ...
  #   expect(response).to have_rendered("new")
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_rendered.rb:60
  def render_template(options, message = T.unsafe(nil)); end
end

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_rendered.rb:7
class RSpec::Rails::Matchers::RenderTemplate::RenderTemplateMatcher < ::RSpec::Rails::Matchers::BaseMatcher
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_rendered.rb:8
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_rendered.rb:29
  def check_redirect; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_rendered.rb:37
  def failure_message; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_rendered.rb:47
  def failure_message_when_negated; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/have_rendered.rb:16
  def matches?(*_arg0); end
end

# Matchers to help with specs for routing code.
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:5
module RSpec::Rails::Matchers::RoutingMatchers
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:101
  def be_routable; end
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:61
  def route_to(*expected); end
end

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:66
class RSpec::Rails::Matchers::RoutingMatchers::BeRoutableMatcher < ::RSpec::Rails::Matchers::BaseMatcher
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:67
  def initialize(scope); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:88
  def description; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:80
  def failure_message; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:84
  def failure_message_when_negated; end

  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:71
  def matches?(path); end
end

# Helpers for matching different route types.
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:106
module RSpec::Rails::Matchers::RoutingMatchers::RouteHelpers
  # Shorthand method for matching this type of route.
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:117
  def delete(path); end
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:9
class RSpec::Rails::Matchers::RoutingMatchers::RouteToMatcher < ::RSpec::Rails::Matchers::BaseMatcher
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:10
  def initialize(scope, *expected); end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:43
  def description; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:35
  def failure_message; end

  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:39
  def failure_message_when_negated; end

  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/routing_matchers.rb:21
...
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:11
class RSpec::Rails::Matchers::SendEmail < ::RSpec::Rails::Matchers::BaseMatcher
  # @api private
  # @return [SendEmail] a new instance of SendEmail
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:16
  def initialize(criteria); end

  # @api private
  # @return [String]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:38
  def failure_message; end

  # @api private
  # @return [String]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:50
  def failure_message_when_negated; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:30
  def matches?(block); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:26
  def supports_block_expectations?; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:21
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:64
  def define_matched_emails(block); end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:60
  def deliveries; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:56
  def diffable?; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:75
  def matched_email?(email); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:88
  def multiple_match?; end

  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:92
...
# @api private
#
# pkg:gem/rspec-rails#lib/rspec/rails/matchers/send_email.rb:14
RSpec::Rails::Matchers::SendEmail::INSPECT_EMAIL_ATTRIBUTES = T.let(T.unsafe(nil), Array)

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:140
module RSpec::Rails::MinitestAssertionAdapter
  extend ::ActiveSupport::Concern

  mixes_in_class_methods ::RSpec::Rails::MinitestAssertionAdapter::ClassMethods

  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:170
  def assertion_delegator; end
end

# pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:165
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:144
module RSpec::Rails::MinitestAssertionAdapter::ClassMethods
  ...
  # Minitest.
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:148
  def assertion_method_names; end

  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:156
  def define_assertion_delegators; end
end

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:94
module RSpec::Rails::MinitestCounters
  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:96
  def assertions; end
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:95
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:66
module RSpec::Rails::MinitestLifecycleAdapter
  extend ::ActiveSupport::Concern

  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:83
  def after_setup; end

  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:89
  def after_teardown; end

  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:80
  def before_setup; end

  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:86
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/model_example_group.rb:6
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/rails_example_group.rb:12
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/request_example_group.rb:5
module RSpec::Rails::RequestExampleGroup
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/request_example_group.rb:16
  def app; end
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/routing_example_group.rb:4
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/routing_example_group.rb:10
module RSpec::Rails::RoutingExampleGroup
  ...
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/routing_example_group.rb:46
  def routes; end

  # @api public
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/routing_example_group.rb:49
  def routes=(routes); end
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/routing_example_group.rb:56
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/routing_example_group.rb:18
module RSpec::Rails::RoutingExampleGroup::ClassMethods
  ...
  #   end
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/routing_example_group.rb:31
  def routes; end
end

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:102
module RSpec::Rails::SetupAndTeardownAdapter
  extend ::ActiveSupport::Concern

  mixes_in_class_methods ::RSpec::Rails::SetupAndTeardownAdapter::ClassMethods

  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:129
  def initialize(*args); end

  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:134
  def method_name; end
end

# pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:105
module RSpec::Rails::SetupAndTeardownAdapter::ClassMethods
  # Wraps `setup` calls from within Rails' testing framework in `before`
  # hooks.
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:108
  ...
  # @api private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:123
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:5
module RSpec::Rails::SystemExampleGroup
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:92
  def app; end

  # @api public
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:87
  def metadata; end

  # @api public
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:40
  def method_name; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:29
  def passed?; end
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:18
module RSpec::Rails::SystemExampleGroup::BlowAwayTeardownHooks
  # @api public
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:24
  def after_teardown; end

  # @api public
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:20
  def before_teardown; end
end
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:15
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:97
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:49
class RSpec::Rails::SystemExampleGroup::SuppressRailsScreenshotMetadata
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:50
  def initialize; end

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:54
  def [](key); end

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:62
  def []=(key, value); end

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:70
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/system_example_group.rb:76
  def raise_wrong_scope_error; end
end

# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:186
module RSpec::Rails::TaggedLoggingAdapter
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:191
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/adapters.rb:183
...
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_assigns.rb:4
module RSpec::Rails::ViewAssigns
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_assigns.rb:11
  def assign(key, value); end

  # Compat-shim for AbstractController::Rendering#view_assigns
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_assigns.rb:16
  def view_assigns; end

  private

  # pkg:gem/rspec-rails#lib/rspec/rails/view_assigns.rb:22
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:9
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:25
module RSpec::Rails::ViewExampleGroup::ClassMethods
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:26
  def _default_helper; end

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:33
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:41
module RSpec::Rails::ViewExampleGroup::ExampleMethods
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:100
  def params; end
  ...
  # @overload render
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:66
  def render(options = T.unsafe(nil), local_assigns = T.unsafe(nil), &block); end

  # @api public
  # @deprecated Use `rendered` instead.
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:111
  def response; end
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:92
  def stub_template(hash); end

  # @api public
  # @deprecated Use `view` instead.
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:105
  def template; end
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:82
  def view; end
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:166
  def _controller_path; end

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:128
  def _default_render_options; end

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:174
  def _include_controller_helpers; end

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:170
  def _inferred_action; end

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:162
  def _path_parts; end
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:17
module RSpec::Rails::ViewExampleGroup::StubResolverCache
  class << self
    # @api public
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/example/view_example_group.rb:18
...
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_path_builder.rb:4
class RSpec::Rails::ViewPathBuilder
  # @return [ViewPathBuilder] a new instance of ViewPathBuilder
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_path_builder.rb:5
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_path_builder.rb:22
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:7
module RSpec::Rails::ViewRendering
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:12
  def controller; end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:38
  ...
  # @private
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:15
...
# @api public
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:19
module RSpec::Rails::ViewRendering::ClassMethods
  # @api public
  # @see RSpec::Rails::ControllerExampleGroup
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:21
  def render_views(true_or_false = T.unsafe(nil)); end

  # @api private
  # @return [Boolean]
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:26
  def render_views?; end
end
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:117
class RSpec::Rails::ViewRendering::EmptyTemplateHandler
  class << self
    # @api public
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:118
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:43
class RSpec::Rails::ViewRendering::EmptyTemplateResolver
  class << self
    # @api public
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:44
    def build(path); end

    # @api public
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:52
    def nullify_template_rendering(templates); end

    # @api public
    #
    # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:65
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:106
class RSpec::Rails::ViewRendering::EmptyTemplateResolver::FileSystemResolver < ::ActionView::FileSystemResolver
  private

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:109
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:74
class RSpec::Rails::ViewRendering::EmptyTemplateResolver::ResolverDecorator < ::ActionView::Resolver
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:83
  def initialize(resolver); end

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:87
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:94
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:128
module RSpec::Rails::ViewRendering::EmptyTemplates
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:133
  def append_view_path(new_path); end

  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:129
  ...
  # @api public
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:139
...
# @private
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_rendering.rb:145
...
#
# pkg:gem/rspec-rails#lib/rspec/rails/view_spec_methods.rb:5
module RSpec::Rails::ViewSpecMethods
  ...
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_spec_methods.rb:11
  def add_to(klass); end

  # Removes methods `extra_params=` and `extra_params` from the indicated class.
  #
  # pkg:gem/rspec-rails#lib/rspec/rails/view_spec_methods.rb:48
