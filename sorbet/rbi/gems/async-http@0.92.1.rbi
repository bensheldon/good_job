...
class Async::HTTP::Body::Pipe
  ...
  # source://async-http//lib/async/http/body/pipe.rb#79
  def close_head; end
  ...
  #
  # source://async-http//lib/async/http/body/pipe.rb#64
  def writer(task); end
end
...
class Async::HTTP::Client < ::Protocol::HTTP::Methods
  ...
  #
  # source://async-http//lib/async/http/client.rb#30
  ...
  # source://async-http//lib/async/http/client.rb#41
  ...
  # source://async-http//lib/async/http/client.rb#88
  def call(request); end

  # source://async-http//lib/async/http/client.rb#80
  def close; end

  # Returns the value of attribute endpoint.
  #
  # source://async-http//lib/async/http/client.rb#55
  def endpoint; end

  # source://async-http//lib/async/http/client.rb#136
  def inspect; end
  ...
  #
  # source://async-http//lib/async/http/client.rb#56
  def protocol; end
  ...
  # source://async-http//lib/async/http/client.rb#150
  def assign_default_tags(tags); end

  # source://async-http//lib/async/http/client.rb#155
...
# source://async-http//lib/async/http/client.rb#18
Async::HTTP::DEFAULT_RETRIES = T.let(T.unsafe(nil), Integer)

# Represents a way to connect to a remote HTTP server.
#
# source://async-http//lib/async/http/endpoint.rb#23
class Async::HTTP::Endpoint < ::IO::Endpoint::Generic
  ...
  #
  # source://async-http//lib/async/http/endpoint.rb#69
  ...
  # source://async-http//lib/async/http/endpoint.rb#142
  ...
  # source://async-http//lib/async/http/endpoint.rb#190
  ...
  # source://async-http//lib/async/http/endpoint.rb#209
  def endpoint=(endpoint); end

  # @return [Boolean]
  #
  # source://async-http//lib/async/http/endpoint.rb#233
  def eql?(other); end

  # source://async-http//lib/async/http/endpoint.rb#237
  def hash; end

  # The hostname is the server we are connecting to:
  #
  # source://async-http//lib/async/http/endpoint.rb#134
  def hostname; end

  # source://async-http//lib/async/http/endpoint.rb#97
  def inspect; end

  # source://async-http//lib/async/http/endpoint.rb#229
  def key; end
  ...
  #
  # source://async-http//lib/async/http/endpoint.rb#151
  def path; end

  # source://async-http//lib/async/http/endpoint.rb#129
  def port; end

  # source://async-http//lib/async/http/endpoint.rb#111
  def protocol; end
  ...
  # @return [Boolean]
  #
  # source://async-http//lib/async/http/endpoint.rb#107
  def secure?; end

  # source://async-http//lib/async/http/endpoint.rb#178
  def ssl_context; end

  # We don't try to validate peer certificates when talking to localhost because they would always be self-signed.
  #
  # source://async-http//lib/async/http/endpoint.rb#170
  def ssl_verify_mode; end

  # source://async-http//lib/async/http/endpoint.rb#93
  def to_s; end

  # source://async-http//lib/async/http/endpoint.rb#83
  def to_url; end

  # Returns the value of attribute url.
  #
  # source://async-http//lib/async/http/endpoint.rb#101
  def url; end

  protected

  # source://async-http//lib/async/http/endpoint.rb#256
  def tcp_endpoint; end

  # source://async-http//lib/async/http/endpoint.rb#243
  def tcp_options; end
  ...
  class << self
    ...
    #
    # source://async-http//lib/async/http/endpoint.rb#42
    def for(scheme, hostname, path = T.unsafe(nil), **options); end

    # source://async-http//lib/async/http/endpoint.rb#31
    def parse(string, endpoint = T.unsafe(nil), **options); end
  end
end

# source://async-http//lib/async/http/endpoint.rb#24
...
class Async::HTTP::Protocol::HTTP2::Client < ::Protocol::HTTP2::Client
  ...
  # source://async-http//lib/async/http/protocol/http2/client.rb#45
  def read_response(response); end

  # source://async-http//lib/async/http/protocol/http2/client.rb#41
