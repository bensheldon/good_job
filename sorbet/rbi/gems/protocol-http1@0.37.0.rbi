...
class Protocol::HTTP1::Body::Chunked < ::Protocol::HTTP::Body::Readable
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/body/chunked.rb:22
  def initialize(connection, headers); end

  # pkg:gem/protocol-http1#lib/protocol/http1/body/chunked.rb:123
  def as_json(*_arg0, **_arg1, &_arg2); end

  # Close the connection and mark the body as finished.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/body/chunked.rb:51
  def close(error = T.unsafe(nil)); end

  # Returns the value of attribute count.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/body/chunked.rb:33
  def count; end

  # @return [Boolean]
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/body/chunked.rb:44
  def empty?; end

  # pkg:gem/protocol-http1#lib/protocol/http1/body/chunked.rb:118
  def inspect; end

  # pkg:gem/protocol-http1#lib/protocol/http1/body/chunked.rb:36
  def length; end
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/body/chunked.rb:71
  def read; end
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/body/chunked.rb:134
...
# pkg:gem/protocol-http1#lib/protocol/http1/body/chunked.rb:63
...
class Protocol::HTTP1::Body::Fixed < ::Protocol::HTTP::Body::Readable
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/body/fixed.rb:17
  def initialize(connection, length); end

  # pkg:gem/protocol-http1#lib/protocol/http1/body/fixed.rb:81
  def as_json(*_arg0, **_arg1, &_arg2); end

  # Close the connection.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/body/fixed.rb:38
  def close(error = T.unsafe(nil)); end
  ...
  # pkg:gem/protocol-http1#lib/protocol/http1/body/fixed.rb:76
  def inspect; end

  # Returns the value of attribute length.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/body/fixed.rb:25
  def length; end

  # Read a chunk of data.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/body/fixed.rb:54
  def read; end
...
class Protocol::HTTP1::Connection
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:731
  def close!(error = T.unsafe(nil)); end
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:723
  ...
  # @return [Boolean]
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:449
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:346
  def read(length); end
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:964
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:808
  def read_fixed_body(length); end

  # Read the body, assuming that we are not receiving any actual data, but just the length.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:824
  def read_head_body(length); end

  # Read headers from the connection until an empty line is encountered.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:495
  def read_headers; end

  # Read a line from the connection.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:378
  def read_line; end
  ...
  # @return [Boolean]
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:355
  def read_line?; end

  # Read the body, assuming that we read until the connection is closed.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:815
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:404
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:935
  def read_request_body(method, headers); end

  # Read a request line from the connection.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:385
  def read_request_line; end

  # Read a response from the connection.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:460
  ...
  # - Otherwise, the body is read according to {read_body}.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:887
  def read_response_body(method, status, headers); end

  # Read a response line from the connection.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:437
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:836
  ...
  # Invokes {read_remainder_body}.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:845
  def read_upgrade_body; end

  # Read some data from the connection.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:339
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:786
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:517
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:750
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:695
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:655
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:595
  ...
  # If the request was a `HEAD` request, the body will be closed, and no data will be written.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:612
  def write_fixed_length_body(body, length, head); end

  # Write headers to the connection.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:316
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:297
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:277
  ...
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:568
  ...
  # The connection will not be persistent after this method is called.
  #
  # pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:536
...
#
# pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:855
...
#
# pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:852
...
#
# pkg:gem/protocol-http1#lib/protocol/http1/connection.rb:858
...
#
# pkg:gem/protocol-http1#lib/protocol/http1/reason.rb:11
module Protocol::HTTP1::Reason; end

# Get the reason phrase for the given status code.
#
# pkg:gem/protocol-http1#lib/protocol/http1/reason.rb:13
