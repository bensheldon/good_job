...
class Protocol::HTTP1::Body::Chunked < ::Protocol::HTTP::Body::Readable
  ...
  # source://protocol-http1//lib/protocol/http1/body/chunked.rb#123
  ...
  #
  # source://protocol-http1//lib/protocol/http1/body/chunked.rb#134
...
class Protocol::HTTP1::Body::Fixed < ::Protocol::HTTP::Body::Readable
  ...
  # source://protocol-http1//lib/protocol/http1/body/fixed.rb#81
  def as_json(*_arg0, **_arg1, &_arg2); end
...
class Protocol::HTTP1::Body::Remainder < ::Protocol::HTTP::Body::Readable
  ...
  # source://protocol-http1//lib/protocol/http1/body/remainder.rb#67
  def as_json(*_arg0, **_arg1, &_arg2); end
...
class Protocol::HTTP1::Connection
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#731
  def close!(error = T.unsafe(nil)); end
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#723
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#866
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#346
  def read(length); end
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#495
  ...
  # @return [Boolean]
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#355
  def read_line?; end

  # Read the body, assuming that we read until the connection is closed.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#815
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#404
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#935
  def read_request_body(method, headers); end

  # Read a request line from the connection.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#385
  def read_request_line; end

  # Read a response from the connection.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#460
  ...
  # - Otherwise, the body is read according to {read_body}.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#887
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#836
  ...
  # Invokes {read_remainder_body}.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#845
  def read_upgrade_body; end

  # Read some data from the connection.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#339
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#517
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#750
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#695
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#655
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#595
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#316
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#297
  ...
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#568
  ...
  # The connection will not be persistent after this method is called.
  #
  # source://protocol-http1//lib/protocol/http1/connection.rb#536
...
#
# source://protocol-http1//lib/protocol/http1/connection.rb#855
...
#
# source://protocol-http1//lib/protocol/http1/connection.rb#858
