...
# pkg:gem/xpath#lib/xpath/dsl.rb:3
module XPath
  include ::XPath::DSL
  extend ::XPath::DSL
...
# pkg:gem/xpath#lib/xpath/dsl.rb:4
module XPath::DSL
  # pkg:gem/xpath#lib/xpath/dsl.rb:101
  def !(*args); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:125
  def !=(rhs); end
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:65
  def +(*expressions); end
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:52
  def [](expression); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:136
  def ancestor(*element_names); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:136
  def ancestor_or_self(*element_names); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:122
  def and(rhs); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:21
  def anywhere(*expressions); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:25
  def attr(expression); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:136
  def attribute(*element_names); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:17
  def axis(name, *element_names); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:58
  def binary_operator(name, rhs); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:90
  def boolean(*args); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:90
  def ceiling(*args); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:13
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:147
  def contains_word(word); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:90
  def count(*args); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:33
  def css(selector); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:5
  def current; end

  # pkg:gem/xpath#lib/xpath/dsl.rb:9
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:143
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:37
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:99
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:67
  def last; end

  # pkg:gem/xpath#lib/xpath/dsl.rb:90
  def local_name(*args); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:154
  def lowercase; end
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:41
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:103
  def n(*args); end
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:166
  def next_sibling(*expressions); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:102
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:162
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:71
  def position; end
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:170
  def previous_sibling(*expressions); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:95
  def qname; end
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:141
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:29
  def text; end
  ...
  # pkg:gem/xpath#lib/xpath/dsl.rb:62
  def union(*expressions); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:158
  def uppercase; end

  # pkg:gem/xpath#lib/xpath/dsl.rb:45
  def where(expression); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:125
  def |(rhs); end

  # pkg:gem/xpath#lib/xpath/dsl.rb:100
  def ~(*args); end
end

# pkg:gem/xpath#lib/xpath/dsl.rb:128
XPath::DSL::AXES = T.let(T.unsafe(nil), Array)

# pkg:gem/xpath#lib/xpath/dsl.rb:152
XPath::DSL::LOWERCASE_LETTERS = T.let(T.unsafe(nil), String)

# pkg:gem/xpath#lib/xpath/dsl.rb:75
XPath::DSL::METHODS = T.let(T.unsafe(nil), Array)

# pkg:gem/xpath#lib/xpath/dsl.rb:105
XPath::DSL::OPERATORS = T.let(T.unsafe(nil), Array)

# pkg:gem/xpath#lib/xpath/dsl.rb:151
XPath::DSL::UPPERCASE_LETTERS = T.let(T.unsafe(nil), String)

# pkg:gem/xpath#lib/xpath/expression.rb:4
class XPath::Expression
  ...
  # pkg:gem/xpath#lib/xpath/expression.rb:20
  def to_s(type = T.unsafe(nil)); end

  # pkg:gem/xpath#lib/xpath/expression.rb:17
...
class XPath::Renderer
  ...
  # pkg:gem/xpath#lib/xpath/renderer.rb:55
  def anywhere(element_names); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:63
  def attribute(current, name); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:51
  def axis(current, name, element_names); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:71
  def binary_operator(name, left, right); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:47
  def child(current, element_names); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:18
  def convert_argument(argument); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:95
  def css(current, selector); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:43
  def descendant(current, element_names); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:106
  def function(name, *arguments); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:75
  def is(one, two); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:91
  def literal(node); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:13
  def render(node); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:28
  def string_literal(string); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:87
  def text(current); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:39
  def this_node; end

  # pkg:gem/xpath#lib/xpath/renderer.rb:102
  def union(*expressions); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:83
  def variable(name); end

  # pkg:gem/xpath#lib/xpath/renderer.rb:59
  ...
  # pkg:gem/xpath#lib/xpath/renderer.rb:112
  def with_element_conditions(expression, element_names); end

  class << self
    # pkg:gem/xpath#lib/xpath/renderer.rb:5
    def render(node, type); end
  end
end

# pkg:gem/xpath#lib/xpath/union.rb:4
class XPath::Union
  include ::Enumerable
  ...
  # pkg:gem/xpath#lib/xpath/union.rb:18
  def each(&block); end
  ...
  # pkg:gem/xpath#lib/xpath/union.rb:22
  def method_missing(*args); end

  # pkg:gem/xpath#lib/xpath/union.rb:29
  def to_s(type = T.unsafe(nil)); end

  # pkg:gem/xpath#lib/xpath/union.rb:26
  def to_xpath(type = T.unsafe(nil)); end
end
