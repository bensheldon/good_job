...
class Async::HTTP::Protocol::HTTP1::Response < ::Async::HTTP::Protocol::Response
  ...
  #
  # source://async-http//lib/async/http/protocol/http1/response.rb#22
  ...
  # @return [Boolean]
  #
  # source://async-http//lib/async/http/protocol/http1/response.rb#34
  def hijack?; end
...
# source://async-http//lib/async/http/protocol/http1/response.rb#19
Async::HTTP::Protocol::HTTP1::Response::UPGRADE = T.let(T.unsafe(nil), String)

# source://async-http//lib/async/http/protocol/http1/server.rb#13
class Async::HTTP::Protocol::HTTP1::Server < ::Async::HTTP::Protocol::HTTP1::Connection
  # Server loop.
  #
  # source://async-http//lib/async/http/protocol/http1/server.rb#42
...
class Async::HTTP::Protocol::HTTP2::Response < ::Async::HTTP::Protocol::Response
  # @return [Response] a new instance of Response
  #
  # source://async-http//lib/async/http/protocol/http2/response.rb#102
  def initialize(stream); end

  # source://async-http//lib/async/http/protocol/http2/response.rb#128
  def build_request(headers); end

  # source://async-http//lib/async/http/protocol/http2/response.rb#112
  def connection; end

  # @return [Boolean]
  #
  # source://async-http//lib/async/http/protocol/http2/response.rb#120
  def head?; end

  # Returns the value of attribute request.
  #
  # source://async-http//lib/async/http/protocol/http2/response.rb#110
  def request; end

  # Send a request and read it into this response.
  #
  # source://async-http//lib/async/http/protocol/http2/response.rb#161
  def send_request(request); end

  # Returns the value of attribute stream.
  #
  # source://async-http//lib/async/http/protocol/http2/response.rb#109
  def stream; end

  # @return [Boolean]
  #
  # source://async-http//lib/async/http/protocol/http2/response.rb#124
  def valid?; end
...
class Async::HTTP::Protocol::HTTP2::Response::Stream < ::Async::HTTP::Protocol::HTTP2::Stream
  ...
  #
  # source://async-http//lib/async/http/protocol/http2/response.rb#72
  def notify!; end
  ...
  #
  # source://async-http//lib/async/http/protocol/http2/response.rb#80
  def wait; end
...
class Async::HTTP::Protocol::HTTP2::Stream < ::Protocol::HTTP2::Stream
  ...
  #
  # source://async-http//lib/async/http/protocol/http2/stream.rb#150
  def closed(error); end

  # Called when the output terminates normally.
  #
  # source://async-http//lib/async/http/protocol/http2/stream.rb#123
  ...
  #
  # source://async-http//lib/async/http/protocol/http2/stream.rb#116
  ...
  # source://async-http//lib/async/http/protocol/http2/stream.rb#140
  def window_updated(size); end
end
...
class Async::HTTP::Protocol::Request < ::Protocol::HTTP::Request
  ...
  # source://async-http//lib/async/http/protocol/request.rb#34
  def remote_address; end

  # source://async-http//lib/async/http/protocol/request.rb#38
