...
# source://skylight//lib/skylight/cli/merger.rb#7
class Skylight::CLI::Merger < ::Thor::Group
  include ::Skylight::CLI::Helpers

  # source://skylight//lib/skylight/cli/merger.rb#68
  def ask_for_child_app; end

  # source://skylight//lib/skylight/cli/merger.rb#77
  def ask_for_child_env; end

  # source://skylight//lib/skylight/cli/merger.rb#49
  def ask_for_parent_app; end

  # source://skylight//lib/skylight/cli/merger.rb#73
  def confirm_child; end

  # source://skylight//lib/skylight/cli/merger.rb#103
  def confirm_child_env; end

  # source://skylight//lib/skylight/cli/merger.rb#107
  def confirm_everything; end

  # source://skylight//lib/skylight/cli/merger.rb#64
  def confirm_parent; end

  # source://skylight//lib/skylight/cli/merger.rb#112
  def do_confirm; end

  # source://skylight//lib/skylight/cli/merger.rb#29
  def fetch_apps; end

  # source://skylight//lib/skylight/cli/merger.rb#19
  def merge_token; end

  # source://skylight//lib/skylight/cli/merger.rb#19
  def merge_token=(_arg0); end

  # source://skylight//lib/skylight/cli/merger.rb#126
  def print_new_config_instructions; end

  # source://skylight//lib/skylight/cli/merger.rb#21
  def welcome; end

  private

  # source://skylight//lib/skylight/cli/merger.rb#226
  def api; end

  # source://skylight//lib/skylight/cli/merger.rb#210
  def ask_for_app(app_list, &formatter); end

  # source://skylight//lib/skylight/cli/merger.rb#274
  def children; end

  # source://skylight//lib/skylight/cli/merger.rb#181
  def do_merge; end

  # source://skylight//lib/skylight/cli/merger.rb#195
  def done!(message: T.unsafe(nil), success: T.unsafe(nil)); end

  # source://skylight//lib/skylight/cli/merger.rb#230
  def format_component(component); end

  # source://skylight//lib/skylight/cli/merger.rb#270
  def parent_component_fingerprints; end

  # source://skylight//lib/skylight/cli/merger.rb#298
  def specify_child_env; end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/cli/merger.rb#262
  def valid_component?(component_name, env); end

  # source://skylight//lib/skylight/cli/merger.rb#243
  def validate_mergeability(child_app, child_env); end

  # source://skylight//lib/skylight/cli/merger.rb#177
  def wrap_hash(hash); end

  class << self
    # source://skylight//lib/skylight/cli/merger.rb#10
    def banner; end
  end
end

# source://skylight//lib/skylight/cli/merger.rb#14
...
class Skylight::Config
  ...
  #
  # source://skylight//lib/skylight/config.rb#237
  def initialize(*args); end

  # source://skylight//lib/skylight/config.rb#405
  def [](key, default = T.unsafe(nil)); end

  # source://skylight//lib/skylight/config.rb#431
  def []=(key, val, scope = T.unsafe(nil)); end

  # source://skylight//lib/skylight/config.rb#563
  ...
  #
  # source://skylight//lib/skylight/config.rb#561
  def alert_logger=(_arg0); end

  # @api private
  #
  # source://skylight//lib/skylight/config.rb#642
  def api; end

  # source://skylight//lib/skylight/config.rb#759
  def as_json(*_arg0); end

  # ===== Helpers =====
  #
  # source://skylight//lib/skylight/config.rb#722
  def authentication_with_meta; end

  # source://skylight//lib/skylight/config.rb#356
  ...
  # source://skylight//lib/skylight/config.rb#685
  def check_sockdir_permissions(sockdir_path); end

  # source://skylight//lib/skylight/config.rb#751
  def component; end

  # source://skylight//lib/skylight/config.rb#742
  def components; end

  # source://skylight//lib/skylight/config.rb#738
  def deploy; end

  # source://skylight//lib/skylight/config.rb#437
  def duration_ms(key, default = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/config.rb#577
  def enable_segments?; end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/config.rb#581
  def enable_sidekiq?; end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/config.rb#589
  def enable_source_locations?; end

  # @api private
  #
  # source://skylight//lib/skylight/config.rb#484
  def gc; end

  # source://skylight//lib/skylight/config.rb#389
  def get(key, default = T.unsafe(nil)); end

  # @api private
  #
  # source://skylight//lib/skylight/config.rb#489
  def ignored_endpoints; end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/config.rb#384
  def key?(key); end

  # source://skylight//lib/skylight/config.rb#519
  def log_level; end

  # source://skylight//lib/skylight/config.rb#545
  def logger; end
  ...
  # source://skylight//lib/skylight/config.rb#549
  def native_log_file; end

  # source://skylight//lib/skylight/config.rb#541
  def native_log_level; end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/config.rb#597
  def on_heroku?; end

  # @api private
  #
  # source://skylight//lib/skylight/config.rb#234
  def priority_key; end

  # source://skylight//lib/skylight/config.rb#515
  def root; end

  # source://skylight//lib/skylight/config.rb#433
  def send_or_get(val); end

  # source://skylight//lib/skylight/config.rb#407
  def set(key, val, scope = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/config.rb#585
  def sinatra_route_prefixes?; end

  # @api private
  #
  # source://skylight//lib/skylight/config.rb#505
  def source_location_ignored_gems; end

  # source://skylight//lib/skylight/config.rb#755
  def to_json(*_arg0); end

  # source://skylight//lib/skylight/config.rb#456
  def to_native_env; end

  # source://skylight//lib/skylight/config.rb#593
  def user_config; end

  # @api private
  #
  # source://skylight//lib/skylight/config.rb#331
  def validate!; end

  # source://skylight//lib/skylight/config.rb#646
  def validate_with_server; end

  # ===== Helpers =====
  #
  # source://skylight//lib/skylight/config.rb#479
  def version; end

  # source://skylight//lib/skylight/config.rb#706
  def write(path); end

  private

  # source://skylight//lib/skylight/config.rb#626
  def cast_for_env(val); end

  # source://skylight//lib/skylight/config.rb#765
  def check_nfs(path); end

  # source://skylight//lib/skylight/config.rb#603
  def create_logger(out, level: T.unsafe(nil)); end

  # source://skylight//lib/skylight/config.rb#616
  def load_logger; end

  # @return [Boolean]
  #
  # source://skylight//lib/skylight/config.rb#770
  def reporting_env?; end

  class << self
    # Default values for Skylight configuration keys
    #
    # source://skylight//lib/skylight/config.rb#124
    def default_values; end

    # Maps legacy config keys to new config keys
    #
    # source://skylight//lib/skylight/config.rb#223
    def legacy_keys; end

    # source://skylight//lib/skylight/config.rb#259
    def load(opts = T.unsafe(nil), env = T.unsafe(nil)); end

    # source://skylight//lib/skylight/config.rb#175
    def native_env_keys; end

    # @api private
    #
    # source://skylight//lib/skylight/config.rb#297
    def remap_env(env); end

    # source://skylight//lib/skylight/config.rb#291
...
# source://skylight//lib/skylight/config.rb#168
...
class Skylight::Instrumenter
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#303
  def broken!; end
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#114
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#178
  ...
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/instrumenter.rb#179
  def disabled?; end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#317
  ...
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/instrumenter.rb#144
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#363
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#340
  def handle_instrumenter_error(trace, err); end

  # @api private
  # @return [Boolean]
  #
  # source://skylight//lib/skylight/instrumenter.rb#349
  def ignore?(trace); end

  # @api private
  # @raise [ArgumentError]
  #
  # source://skylight//lib/skylight/instrumenter.rb#257
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#152
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#323
  def process(trace); end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#211
  def shutdown; end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#168
  def silence_warnings(context); end

  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#181
  def start!; end
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#216
  ...
  # @api private
  #
  # source://skylight//lib/skylight/instrumenter.rb#160
  def unmute; end
...
# source://skylight//lib/skylight/normalizers/graphql/base.rb#130
...
class Skylight::Normalizers::GraphQL::Execute < ::Skylight::Normalizers::GraphQL::Base
  ...
  #
  # source://skylight//lib/skylight/normalizers/graphql/base.rb#68
  def normalize(trace, name, payload); end

  # source://skylight//lib/skylight/normalizers/graphql/base.rb#72
  def normalize_after(trace, span, name, payload); end

  private

  # source://skylight//lib/skylight/normalizers/graphql/base.rb#89
  def _execute_multiplex_normalize_after(trace, _span, _name, payload); end

  # source://skylight//lib/skylight/normalizers/graphql/base.rb#78
...
# source://skylight//lib/skylight/normalizers/graphql/base.rb#124
...
# source://skylight//lib/skylight/normalizers/graphql/base.rb#120
...
# source://skylight//lib/skylight/normalizers/graphql/base.rb#134
class Skylight::Normalizers::GraphQL::ExecuteQueryLazy < ::Skylight::Normalizers::GraphQL::ExecuteQuery
  # source://skylight//lib/skylight/normalizers/graphql/base.rb#137
  def normalize(trace, _name, payload); end
end
