...
module PgHero
  class << self
    # source://pghero//lib/pghero.rb#58
    def analyze(*args, **_arg1, &block); end

    # source://pghero//lib/pghero.rb#206
    ...
    # source://pghero//lib/pghero.rb#213
    ...
    # source://pghero//lib/pghero.rb#191
    def capture_query_stats(verbose: T.unsafe(nil)); end

    # source://pghero//lib/pghero.rb#199
    ...
    #
    # source://pghero//lib/pghero.rb#227
    def clean_query_stats(before: T.unsafe(nil)); end

    # source://pghero//lib/pghero.rb#233
    ...
    # private
    #
    # source://pghero//lib/pghero.rb#240
    ...
    #
    # source://pghero//lib/pghero.rb#173
    def databases; end
    ...
    # private
    #
    # source://pghero//lib/pghero.rb#250
    ...
    # source://pghero//lib/pghero.rb#220
    def pretty_size(value); end

    # source://pghero//lib/pghero.rb#187
    ...
    # source://pghero//lib/pghero/engine.rb#3
    ...
    # source://pghero//lib/pghero.rb#256
...
module PgHero::Methods::Basic
  ...
  # source://pghero//lib/pghero/methods/basic.rb#117
  def add_source(sql); end

  # source://pghero//lib/pghero/methods/basic.rb#104
  def execute(sql); end

  # source://pghero//lib/pghero/methods/basic.rb#121
  def quote(value); end

  # source://pghero//lib/pghero/methods/basic.rb#129
  def quote_column_name(value); end

  # source://pghero//lib/pghero/methods/basic.rb#125
  ...
  # source://pghero//lib/pghero/methods/basic.rb#45
  def select_all_leased(sql, conn:, query_columns:); end

  # source://pghero//lib/pghero/methods/basic.rb#92
  def select_all_size(sql); end

  # source://pghero//lib/pghero/methods/basic.rb#88
  def select_all_stats(sql, **options); end

  # source://pghero//lib/pghero/methods/basic.rb#100
  def select_one(sql); end

  # source://pghero//lib/pghero/methods/basic.rb#113
  def squish(str); end

  # @return [Boolean]
  #
  # source://pghero//lib/pghero/methods/basic.rb#150
  def table_exists?(table); end

  # source://pghero//lib/pghero/methods/basic.rb#133
  def unquote(part); end

  # source://pghero//lib/pghero/methods/basic.rb#108
  def with_connection(stats: T.unsafe(nil), &block); end

  # source://pghero//lib/pghero/methods/basic.rb#141
...
module PgHero::Methods::Sequences
  # source://pghero//lib/pghero/methods/sequences.rb#59
  ...
  #
  # source://pghero//lib/pghero/methods/sequences.rb#90
  ...
  #
  # source://pghero//lib/pghero/methods/sequences.rb#69
  def parse_default_value(default_value); end

  # source://pghero//lib/pghero/methods/sequences.rb#79
...
module PgHero::Methods::SuggestedIndexes
  ...
  # source://pghero//lib/pghero/methods/suggested_indexes.rb#89
  ...
  # source://pghero//lib/pghero/methods/suggested_indexes.rb#95
  def best_index_helper(statements); end

  # source://pghero//lib/pghero/methods/suggested_indexes.rb#198
  def best_index_structure(statement); end

  # source://pghero//lib/pghero/methods/suggested_indexes.rb#315
  def column_stats(schema: T.unsafe(nil), table: T.unsafe(nil)); end

  # source://pghero//lib/pghero/methods/suggested_indexes.rb#306
  def parse_sort(sort_clause); end

  # source://pghero//lib/pghero/methods/suggested_indexes.rb#271
  def parse_table(tree); end

  # TODO capture values
  #
  # source://pghero//lib/pghero/methods/suggested_indexes.rb#283
  ...
  #
  # source://pghero//lib/pghero/methods/suggested_indexes.rb#239
  def row_estimates(stats, total_rows, rows_left, op); end

  # source://pghero//lib/pghero/methods/suggested_indexes.rb#302
  def str_method; end
end
