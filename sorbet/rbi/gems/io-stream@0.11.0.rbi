...
#
# source://io-stream//lib/io/stream/buffered.rb#11
class IO::Stream::Buffered < ::IO::Stream::Generic
  ...
  #
  # source://io-stream//lib/io/stream/buffered.rb#80
  def close_read; end

  # Close the write end of the stream.
  #
  # source://io-stream//lib/io/stream/buffered.rb#85
  def close_write; end
  ...
  # @return [Boolean]
  #
  # source://io-stream//lib/io/stream/buffered.rb#75
  def closed?; end
  ...
  # @return [Boolean]
  #
  # source://io-stream//lib/io/stream/buffered.rb#93
  def readable?; end

  # Get the underlying IO object.
  #
  # source://io-stream//lib/io/stream/buffered.rb#69
  def to_io; end

  protected

  # source://io-stream//lib/io/stream/buffered.rb#105
  def sysclose; end

  # Reads data from the underlying stream as efficiently as possible.
  #
  # source://io-stream//lib/io/stream/buffered.rb#136
  ...
  class << self
    ...
    #
    # source://io-stream//lib/io/stream/buffered.rb#17
    def open(path, mode = T.unsafe(nil), **options); end

    # Wrap an existing IO object in a buffered stream.
    #
    # source://io-stream//lib/io/stream/buffered.rb#33
...
#
# source://io-stream//lib/io/stream/connection_reset_error.rb#5
