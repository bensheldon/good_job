...
- `environment` (string) The environment to display in the dashboard. Defaults to `Rails.env`. You can also set this with the environment variable `GOOD_JOB_ENVIRONMENT`.
